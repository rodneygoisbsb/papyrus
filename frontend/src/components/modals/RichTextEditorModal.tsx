                ...
                <div className="px-6 py-4 border-t border-base-300 flex justify-between items-center bg-base-100 shrink-0">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="bg-primary hover:bg-primary/90 text-white text-xs font-bold px-6 py-2.5 rounded-xl shadow-md shadow-primary/20 transition-all active:scale-95 cursor-pointer"
                        >
                            Salvar Anotações
                        </button>
                    </div>
