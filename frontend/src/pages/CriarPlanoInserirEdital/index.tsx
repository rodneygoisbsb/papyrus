...
export default function CriarPlanoInserirEditalPage({ setActiveTab }: Props) {
    return (
        <div className="space-y-8 font-['Plus_Jakarta_Sans'] text-base-content animate-in fade-in duration-300">
            ...
            <div className="flex flex-col gap-4 pb-6 border-b border-base-300/70">
                ...
                <div>
                    <h2 className="text-3xl font-black text-base-content tracking-tight">Inserir Edital Oficial</h2>
                    <p className="text-sm text-neutral-content mt-2 max-w-2xl">
                        Faça o upload ou cole o texto do seu edital e nós montamos o plano para você.
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center p-12 bg-base-100 rounded-3xl border border-base-200 shadow-sm min-h-[400px]">
                <FileDown size={64} className="text-emerald-600/40 mb-4" />
                ...
                <p className="text-sm text-neutral-content mt-2 text-center max-w-md">
                    Em breve você poderá anexar o PDF do edital e a nossa Inteligência Artificial fará todo o trabalho duro de separar disciplinas e assuntos!
                </p>
            </div>
        </div>
    );
